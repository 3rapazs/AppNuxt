...
import ProductModel from "../../model/master/productModel";
...
<template>
  ...
  >
    <NuxtLink
      :to="{ path: '/productinfo', query: { id: productModel?.ProductId } }"
    >
    ...
    <div class="pt-6">
      ...
      <div class="mt-4 flex items-center justify-between gap-4">
        ...
        >
          <!-- $1,699 -->
          ฿{{ new Intl.NumberFormat("en-US").format(productModel?.Price ?? 0) }}
        </p>
